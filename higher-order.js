...
//Code Here
let totalPopulation = populations.reduce((accumulator, value) => accumulator += value)
...
let ordersTotal = orders.map(e => {return e.price = e.price + (e.price * e.tax)});
...
let bobsTotal = purchases.filter(e => e.owner === 'Bob').map(e => e.price).reduce((accumulator, value) => accumulator += value);
